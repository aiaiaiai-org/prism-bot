...
module PrismBot
  module Client
    class Composition
      attr_reader :command_handlers, :state_handlers, :fallback, :state_store

      def initialize(command_handlers:, fallback:, state_handlers: {}, state_store: nil)
      ...
      def with(command_handlers: {}, state_handlers: {}, fallback: @fallback, state_store: @state_store)
        self.class.new(
